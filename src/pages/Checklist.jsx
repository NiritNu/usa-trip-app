...
const checklistGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: "nvidia-card",
        title: "כרטיס עובד NVIDIA",
        note: "לזכור לקחת לטיול.",
        priority: "medium",
      },
      {
        id: "shaked-disability-card",
        title: "כרטיס נכה של שקד",
        note: "לשמור נגיש יחד עם שאר המסמכים החשובים.",
        priority: "high",
      },
      {
        id: "debit-card",
        title: "Debit Card",
        note: "כרטיס נוסף לתשלומים / גיבוי.",
        priority: "high",
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: "print-orlando-flight-tickets",
        title: "להדפיס כרטיסי טיסה לאורלנדו",
...

  {
    ...
    items: [
      ...
      },
      {
        id: "sunglasses",
        title: "משקפי שמש",
        note: "לימים בעיר ובפארקים.",
        priority: "high",
      },
      {
        id: "backup-glasses",
        title: "משקפי גיבוי",
        note: "זוג נוסף למקרה של אובדן או שבר.",
        priority: "high",
      },
      {
        id: "regular-glasses",
