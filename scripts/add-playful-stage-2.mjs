...
const disneyPage = String.raw`import { useMemo, useState } from "react";
...
const universalPage = String.raw`import { useMemo, useState } from "react";
import AttractionCard from "../components/AttractionCard.jsx";
...
writeFile("src/pages/Disney.jsx", disneyPage);
writeFile("src/pages/Universal.jsx", universalPage);
...
.mood-card {
  border-color: #fecdd3;
  background:
    radial-gradient(circle at top left, rgba(254, 205, 211, 0.5), transparent 34%),
...
if (!css.includes("/* Playful stage 2 */")) {
  css += cssToAdd;
  fs.writeFileSync(cssPath, css, "utf8");
}

console.log("Added playful stage 2 design to Disney and Universal.");
console.log("Updated:");
console.log("src/pages/Disney.jsx");
console.log("src/pages/Universal.jsx");
